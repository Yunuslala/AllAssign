...
staticschema.find({}, (staticErr, staticResult) => {
    if (staticErr) {
        ...
        mongoose.model("static", staticSchema).create(object1, object2, (staticErr1, staticResult1) => {
            if (staticErr1) {
                console.log("Default static content creation error:", staticErr1);
            }
            else {
                console.log("Default static content created successfully:", staticResult1);
            }
        })
    }
})
