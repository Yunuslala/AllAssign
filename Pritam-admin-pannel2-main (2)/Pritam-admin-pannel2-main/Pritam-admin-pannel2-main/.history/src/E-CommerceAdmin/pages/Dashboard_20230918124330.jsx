...
const Dashboard = () => {
  ...
  const card = [
    ...
    },
    {
      ...
      number: data?.staff,
      icon: (
        <i className="fa-solid fa-users text-2xl text-[#3c335d]"></i>
      ),
      bg: "#3c335d",
      link: "/staff",
    },
    {
      ...
      title: "All Events",
      number: data?.Event,
      icon: <i className="fa-solid fa-calendar-days text-2xl text-[#64878e]"></i>,
      bg: "#64878e",
      link: "/event",
    },
    ...
    },
    {
      ...
      icon: (
        <i className="fa-solid fa-gears text-2xl text-[#3c335d]"></i>
      ),
      bg: "#3c335d",
...

    {
      ...
      icon: (
        <i className=" fa-solid fa-globe text-2xl text-[#1b6975]"></i>
      ),
      bg: "#1b6975",
      link: "/getWhoWeAre",
    },
