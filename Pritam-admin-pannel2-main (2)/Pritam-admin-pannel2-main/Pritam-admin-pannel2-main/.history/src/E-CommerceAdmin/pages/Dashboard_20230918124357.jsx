...
const Dashboard = () => {
  ...
  const card = [
    ...
    },
    {
      ...
      icon: <i className="fa-solid fa-gears text-2xl text-[#3c335d]"></i>,
      bg: "#3c335d",
...

    {
      ...
      icon: <i className=" fa-solid fa-globe text-2xl text-[#1b6975]"></i>,
      bg: "#1b6975",
      link: "/getWhoWeAre",
    },
    {
      ...
      title: "Courses",
      number: data?.Course,
      icon: <i className=" fa-solid fa-book text-2xl text-[#1b6975]"></i>,
      bg: "#1b6975",
      link: "/courses",
    },
  ];
