...
const fetchTask=async()=>{
    ...
    const res=await axios.get('https://teal-real-bear.cyclic.app/Task/get',{headers});
    const task=res.data
    console.log(task)
    setTasks(task)
}
  ...
  const handleCreateTask = async() => {
    try {
        ...
        const response=await axios.post('https://teal-real-bear.cyclic.app/Task/add', newTask ,{headers});
  ...
  const handleDeleteTask=async(id)=>{
    ...
    const deleteTask=await axios.delete(`https://teal-real-bear.cyclic.app/Task/deleteTask/${id}` ,{headers});
